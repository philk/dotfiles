...
-- beautiful.init("/home/phil/.config/awesome/themes/zeb/theme")
...
tags = {}
tags.setup = {
    { name = "browser", layout = layouts[9] },
    { name = "terms", layout = layouts[1] },
...
local weatherwidget = widget({ type = "textbox", name = "weatherwidget" })
vicious.register(weatherwidget, vicious.widgets.weather, "${tempf}F", 3600, "KFPR")

datewidget = widget({ type = "textbox", name = "datewidget" })
vicious.register(datewidget, vicious.widgets.date, '%a %b %d, %I:%M')
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        cpuwidget.widget, cpuicon, separator,
        memwidget.widget, memicon, separator,
        neticonup, netwidget, neticon, separator,
        mpdwidget,
        mytasklist[s],
